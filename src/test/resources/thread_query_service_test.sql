...
INSERT INTO app_user (username, password, role, enabled) VALUES ('user3', '$2a$10$o.4VZ6Ixb7PZeHuQX5.5Ve86jaySj8E1kkQIC/r0bCdT5bns5xScS', 'ROLE_USER', TRUE);
...
INSERT INTO thread (content, app_user_id, topic_id, like_count, created_on) VALUES ('topic_2_content1', 2, 2, 0, '2020-01-03');
INSERT INTO thread (content, app_user_id, topic_id, like_count, created_on) VALUES ('topic_2_content2', 2, 2, 0, '2020-01-03');
INSERT INTO thread (content, app_user_id, topic_id, like_count, created_on) VALUES ('topic_3_content1', 3, 3, 0, '2020-01-03');
INSERT INTO thread (content, app_user_id, topic_id, like_count, created_on) VALUES ('topic_3_content2', 3, 3, 0, '2020-01-03');
