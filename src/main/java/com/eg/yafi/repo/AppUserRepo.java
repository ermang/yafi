...
//    @Query(value = "SELECT new com.eg.yafi.dto.out.ReadThread(t.id AS id, t.topic.id AS topicId, t.content AS content, t.appUser.username AS username)" +
//            "    FROM Thread t" +
//            "    WHERE t.id = :threadId")
//public ReadUser(Long id, String username, String role, boolean enabled)
    @Query(value = "SELECT new com.eg.yafi.dto.out.ReadUser(a.id AS id, a.username AS username, a.password AS password," +
